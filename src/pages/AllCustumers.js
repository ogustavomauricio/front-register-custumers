...
async function handleDelete(id){
          ...
          <TableRow key={custumer.id}>
            ...
            <TableCell align="center">
              <ButtonGroup  aria-label="outlined primary button group">
                <Button color="primary" href={'/updatecustumers/'+custumer._id }>Editar</Button>
                <Button color="secondary" onClick={() => handleDelete(custumer)}>Deletar</Button>
              </ButtonGroup>
            </TableCell>
          </TableRow>
        ))}
  ...
  <ButtonGroup >
    <Button color="primary" href='/registercustumers' className='btnVoltar'>
      Voltar
    </Button>
    </ButtonGroup>
  </div>
